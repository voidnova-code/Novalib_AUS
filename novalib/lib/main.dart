...
class ApiService {
  ...
  static const String baseUrl = 'http://192.168.165.28:8000';
  ...
  static Future<void> loadUserData() async {
    ...
    if (studentId != null) {
      try {
        ...
        // Filter recommended books to show only available ones
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadData() async {
    try {
      await AppData.loadUserData();
      setState(() {
        _filteredBooks = AppData.issuedBooks
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: AppData.recommendedBooks.length,
                  itemBuilder: (context, index) {
                    final book = AppData.recommendedBooks[index];
                    return _buildRecommendedCard(book.title, book.author);
                  },
                ),
              ),
            ],
  ...
  Widget _buildRecommendedCard(String title, String author) {
    return Container(
      width: 140,
